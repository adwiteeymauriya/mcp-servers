...
If you prefer to use Docker instead of running Node.js directly, you can build and run the MCP server using the provided Dockerfile:
...
When using Docker, update your `cline_mcp_settings.json` to point to the Docker container:
